      ...
      <div className="page-section">
        ...
        <div className="">
          <div className="">
            <h3>Mission</h3>
            <p>
              We promote healthy lives in the world’s impoverished communities,
              work to improve longevity for people living with HIV/AIDS, and
              work to reduce the social stigma, transmission, and HIV-related
              morbidity and mortality by innovative methods.
            </p>
          </div>
          <div>
            <h3>Vision</h3>
            <p>
              ...
              improved the quality of life for people living in the world’s most
          ...
          <div>
            ...
            <p>
              ...
              excellence, innovation, compassion, and respect for human dignity.
            </p>
          </div>
        </div>
